...
def add_subtitles(video_path: str, scenes: list, audio_duration: float, out_path: str, scene_durs: list = None) -> bool:
    total_scenes = len(scenes)
    # Use proportional durations if provided, else equal split
    if scene_durs and len(scene_durs) == total_scenes:
        scene_dur_list = scene_durs
    else:
        per = audio_duration / total_scenes
        scene_dur_list = [per] * total_scenes
    filters      = []
